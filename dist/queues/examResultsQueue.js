...
examResultsQueue.process(1, async (job) => {
    try {
        const participated = job.data.participated;
        ...
        await sendExamResultEmail(participated.user.email, participated.exam.title, participated.exam.questionCount, score.correctAnswers);
